      ...
      "/server/": [
        {
          title: "Java-EE",
          collapsable: false,
          children: ["/server/java-ee/modifier", "/server/java-ee/iterable"],
        },
        {
          title: "Mysql",
          // collapsable: false,
      ...
      "/ui-frame/": [
        {
          ...
          collapsable: false,
          sidebarDepth: 0,
          children: ["/ui-frame/build/vue"],
        },
        {
          title: "PC端",
          collapsable: false,
          sidebarDepth: 0,
          children: ["/ui-frame/pc/backbar"],
        },
        {
          title: "模板打印",
          collapsable: false,
          sidebarDepth: 0,
          children: ["/ui-frame/print/execute"],
        },
      ],
    },
  },
